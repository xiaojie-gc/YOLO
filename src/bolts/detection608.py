...
class DetectionBolt_608(Bolt):
    ...
    def process(self, tup):
        ...
        with open(img_path + "/" + str(self.total) + "_608_" + img_name, 'wb') as file:
            file.write(base64.b64decode(img_data))
        objs, cpu, computation_time = self.detect_image(str(self.total) + "_608_" + img_name,  img_path)
        self.emit(["YOLO608", [cpu, computation_time], self.total, objs])
